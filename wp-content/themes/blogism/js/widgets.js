var blogism_custom_theme_file_frame;
...
jQuery(function($){
      ...
      jQuery(document).on('click', 'input.select-img', function( event ){
        ...
        var blogismCustomThemeImage = wp.media.controller.Library.extend({
            defaults : _.defaults({
        ...
        blogism_custom_theme_file_frame = wp.media.frames.blogism_custom_theme_file_frame = wp.media({
          button: {
            text: jQuery( this ).data( 'uploader_button_text' )
          },
          state : 'custom-theme-insert-image',
              states : [
                  new blogismCustomThemeImage()
              ],
          multiple: false
        });

        // When an image is selected, run a callback.
        blogism_custom_theme_file_frame.on( 'select', function() {

          var state = blogism_custom_theme_file_frame.state('custom-theme-insert-image');
        ...
        blogism_custom_theme_file_frame.open();
      });
