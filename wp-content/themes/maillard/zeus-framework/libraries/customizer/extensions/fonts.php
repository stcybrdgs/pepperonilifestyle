...
if ( ! function_exists( 'customizer_library_get_font_choices' ) ) :
	...
	function customizer_library_get_all_fonts() {
		$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'zeus-framework' ) ) ) );
		$standard_fonts = customizer_library_get_standard_fonts();
		$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'zeus-framework' ) ) ) );
...
if ( ! function_exists( 'customizer_library_get_google_font_subsets' ) ) :
	...
	function customizer_library_get_google_font_subsets() {
		return array(
		'all'          => __( 'All', 'zeus-framework' ),
		'cyrillic'     => __( 'Cyrillic', 'zeus-framework' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'zeus-framework' ),
		'devanagari'   => __( 'Devanagari', 'zeus-framework' ),
		'greek'        => __( 'Greek', 'zeus-framework' ),
		'greek-ext'    => __( 'Greek Extended', 'zeus-framework' ),
		'khmer'        => __( 'Khmer', 'zeus-framework' ),
		'latin'        => __( 'Latin', 'zeus-framework' ),
		'latin-ext'    => __( 'Latin Extended', 'zeus-framework' ),
		'vietnamese'   => __( 'Vietnamese', 'zeus-framework' ),
		);
	}
endif;
...
if ( ! function_exists( 'customizer_library_get_standard_fonts' ) ) :
	...
	function customizer_library_get_standard_fonts() {
		return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'zeus-framework' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif',
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'zeus-framework' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif',
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'zeus-framework' ),
