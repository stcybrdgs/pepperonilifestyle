...
//HELPDESK SECTION
	$wp_customize->add_section(
		...
		<br><hr><br>
		<a style="display:block;" href="https://writerstheme.github.io/writers/writers/" target="_blank"><img src="https://writerstheme.github.io/writers/writers/img/theme-img.png"></a>
			', 'writers' ),
			)
		);  
...
//UNLOCK SECTION
	$wp_customize->add_section(
		'writers_unlock',
		array(
			'title' => __('Unlock More Features', 'writers'),
			'priority' => 9999999,
		'description' => __( '<a style="display:block;" href="https://writerstheme.github.io/writers/writers/" target="_blank"><img src="https://writerstheme.github.io/writers/writers/img/theme-img.png"></a>
			', 'writers' ),
			)
		);  
	$wp_customize->add_setting('writers_unlock[info]', array(
		'sanitize_callback' => 'writers_no_sanitize',
		'type' => 'info_control',
		'capability' => 'edit_theme_options',
		)
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'unlock_section', array(
		'section' => 'writers_unlock',
		'settings' => 'writers_unlock[info]',
		'type' => 'textarea',
		'priority' => 1
		) )
	);   
