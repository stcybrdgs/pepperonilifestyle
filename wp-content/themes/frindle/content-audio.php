...
<article class="post <?php if ( get_theme_mod( 'custom_post' ) == 1 ) : ?> post-audio <?php endif; ?>">
	
<h2><i class="fa fa-volume-up" aria-hidden="true"></i> <a href="<?php the_permalink(); ?>"> <?php the_title(); ?></a></h2>
