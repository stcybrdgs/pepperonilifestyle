...
jQuery('.magnific__lightbox').each(function() {
  var jQuerycontainer = jQuery(this);
  var jQueryimageLinks = jQuerycontainer.find('.magnific-item');
  ...
  removalDelay: 1000, //delay removal by X
    items: items,
    gallery:{
        enabled:true,
	...
	beforeClose: function() {
        this.content.addClass('fadeOutRight');
    }, 
    close: function() {
        this.content.removeClass('fadeOutRight'); 
    },
      beforeOpen: function() {
