...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'smartpress' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'smartpress' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'smartpress' ),
		'cyrillic'     => __( 'Cyrillic', 'smartpress' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'smartpress' ),
		'devanagari'   => __( 'Devanagari', 'smartpress' ),
		'greek'        => __( 'Greek', 'smartpress' ),
		'greek-ext'    => __( 'Greek Extended', 'smartpress' ),
		'khmer'        => __( 'Khmer', 'smartpress' ),
		'latin'        => __( 'Latin', 'smartpress' ),
		'latin-ext'    => __( 'Latin Extended', 'smartpress' ),
		'vietnamese'   => __( 'Vietnamese', 'smartpress' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'smartpress' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'smartpress' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'smartpress' ),
