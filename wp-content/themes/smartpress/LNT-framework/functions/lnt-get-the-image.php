...
add_action( 'save_post',         'smartpress_get_the_Image_delete_cache_by_post'        );
add_action( 'deleted_post_meta', 'smartpress_get_the_Image_delete_cache_by_meta', 10, 2 );
add_action( 'updated_post_meta', 'smartpress_get_the_Image_delete_cache_by_meta', 10, 2 );
add_action( 'added_post_meta',   'smartpress_get_the_Image_delete_cache_by_meta', 10, 2 );

/**
 * The main image function for displaying an image.  This is a wrapper for the Smartr_Get_The_Image class. Use this 
 ...
 */
function smartpress_get_the_Image( $args = array() ) {

	$image = new Smartr_Get_The_Image( $args );
 ...
 * what you're doing and expect your code to break in future versions.  Use the the `smartpress_get_the_Image()` 
 * wrapper function instead.  That's the reason it exists.
 *
 * @since  1.0.0
 * @access private
 */
final class Smartr_Get_The_Image {
	...
	public function __construct( $args = array() ) {
		...
		add_filter( 'smartpress_get_the_Image_post_content', array( $wp_embed, 'run_shortcode' ) );
		add_filter( 'smartpress_get_the_Image_post_content', array( $wp_embed, 'autoembed'     ) );
	...
	public function get_image() {
		...
		$image_html = apply_filters( 'smartpress_get_the_Image', $this->image );
	...
	public function find() {
		...
		$image_cache = wp_cache_get( $this->args['post_id'], 'smartpress_get_the_Image' );
		...
		if ( !isset( $image_cache[ $key ] ) || empty( $cache ) ) {
			...
			if ( !empty( $this->image ) ) {
				...
				wp_cache_set( $this->args['post_id'], $image_cache, 'smartpress_get_the_Image' );
			}
		}
	...
	public function get_scan_image() {
		...
		$post_content = apply_filters( 'smartpress_get_the_Image_post_content', $post_content );
 ...
 * @return void
 */
function smartpress_get_the_Image_delete_cache_by_post( $post_id ) {
	wp_cache_delete( $post_id, 'smartpress_get_the_Image' );
}
 ...
 * @return void
 */
function smartpress_get_the_Image_delete_cache_by_meta( $meta_id, $post_id ) {
	wp_cache_delete( $post_id, 'smartpress_get_the_Image' );
}
 ...
 * @access     public
 */
function smartpress_get_the_Image_link() {
	_deprecated_function( __FUNCTION__, '0.3.0', 'smartpress_get_the_Image' );
	smartpress_get_the_Image( array( 'link_to_post' => true ) );
}
 ...
 * @access     private
 */
function smartpress_get_the_Image_delete_cache() {}
 ...
 * @access     private
 */
function smartpress_get_the_Image_by_meta_key() {}
 ...
 * @access     private
 */
function smartpress_get_the_Image_by_post_thumbnail() {}
 ...
 * @access     private
 */
function smartpress_get_the_Image_by_attachment() {}
 ...
 * @access     private
 */
function smartpress_get_the_Image_by_scan() {}
 ...
 * @access     private
 */
function smartpress_get_the_Image_by_default() {}
 ...
 * @access     private
 */
function smartpress_get_the_Image_format() {}
 ...
 * @access     private
 */
function smartpress_get_the_Image_meta_key_save() {}
