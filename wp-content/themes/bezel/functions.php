<?php
/**
 * Bezel functions and definitions
 *
 * @package Bezel
 */
...
function bezel_setup() {
	...
	add_editor_style( array ( 'css/editor-style.css', bezel_fonts_url() ) );
...
function bezel_scripts() {
	...
	if ( is_singular() && wp_attachment_is_image() ) {
		wp_enqueue_script( 'bezel-keyboard-image-navigation', get_template_directory_uri() . '/js/keyboard-image-navigation.js', array( 'jquery' ), '20140127', true );
	}

	// Custom Script
	wp_enqueue_script( 'bezel-custom', get_template_directory_uri() . '/js/custom.js', array( 'jquery' ), '1.0', true );
	...
	// Bootstrap
	wp_enqueue_style( 'bezel-bootstrap-grid', get_template_directory_uri() . '/css/bootstrap-grid.css' );
	...
	// Theme Stylesheet
	wp_enqueue_style( 'bezel-style', get_stylesheet_uri() );
