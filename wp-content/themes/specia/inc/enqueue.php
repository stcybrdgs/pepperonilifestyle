...
function specia_style_configurator_enqueue(){
	wp_enqueue_style('style-configurator', get_template_directory_uri() . '/css/style-configurator.css');
}
add_action( 'admin_enqueue_scripts', 'specia_style_configurator_enqueue' );
?>